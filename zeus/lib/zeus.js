...
module.exports = require('hypospray').bind(function(fs, path, winston) {

	var exports = {};
	var package = this.require('../package'),
		Zeusfile = exports.Zeusfile = this.require('./zeusfile'),
		Context = exports.Context = this.require('./context'),
		ZeusService = exports.ZeusService = this.require('./zeusservice'),
		ConfigSetting = exports.ConfigSetting = this.require('./configsetting'),
		Environment = exports.Environment = this.require('./environment'),
		ServiceInstance = exports.ServiceInstance = this.require('./serviceinstance');
