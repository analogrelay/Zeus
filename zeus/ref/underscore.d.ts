...
declare module "underscore" {
    ...
    export function map<T, U>(list: IMap<T>, iterator: (value: T) => U, context?: any): U[];
    export function map<T, U>(list: IMap<T>, iterator: (value: T, key: string) => U, context?: any): U[];
    export function map<T, U>(list: IMap<T>, iterator: (value: T, key: string, list: IMap<T>) => U, context?: any): U[];
